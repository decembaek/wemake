...
export default [
  ...
  ...prefix('/jobs', [
    index('features/job/pages/jobs-page.tsx'),
  ...
  ...prefix('/auth', [
    layout('features/auth/layouts/auth-layout.tsx', [
      ...
      ...prefix('/otp', [
        route('/start', 'features/auth/pages/otp-page.tsx'),
        route('/complete', 'features/auth/pages/otp-complete-page.tsx'),
      ]),
      ...prefix('/social/:provider', [
        route('/start', 'features/auth/pages/social-auth-page.tsx'),
        route('/complete', 'features/auth/pages/social-auth-complete-page.tsx'),
      ]),
    ]),
  ]),
  ...prefix('/community', [
  ...
  ...prefix('/my', [
    layout('features/users/layouts/dashboard-layout.tsx', [
      ...prefix('/dashboard', [
        index('features/my/pages/dashboard-page.tsx'),
        route('/ideas', 'features/my/pages/dashboard-ideas-page.tsx'),
        route(
          '/products/:productId',
          'features/my/pages/dashboard-product-page.tsx'
        ),
      ]),
    ]),
    ...
    route('/profile', 'features/my/pages/my-profile-page.tsx'),
